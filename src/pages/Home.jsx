    ...
    <div className="min-h-screen w-full relative">
      ...
      >
        ...
        <img
          src="/logo2.jpg"
          alt="Chef"
          className={`absolute top-0 w-11/12   xl:w-160 object-contain drop-shadow-lg border-b-[10px] border-[#6f4668]
          ${
            i18n.language === "ar"
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight">
            <span className="text-[#6f4668]"> {t("welcome")}</span> {t("name")}
          </h1>
          ...
          <p className="text-xl md:text-2xl lg:text-3xl whitespace-pre-wrap/relaxed font-[400]">
            <FaLocationDot className="inline-block text-[#6f4668]" />{" "}
            {t("location")}
          </p>
          <TextFade
            direction="up"
          ...
          >
            <MotionButton
              ...
              className="flex items-center w-full justify-between cursor-pointer bg-[#6f4668] rounded-lg  px-4 py-2 md:py-3 text-[#f7f7f7] hover:bg-[#6f4668]/90 transition-all duration-300 "
            ...
            >
              ...
              {t("whatsapp")}
              <div className="h-9 w-9 md:h-12 md:w-12 lg:h-14 lg:w-14 p-1.5 md:p-2 border-2 border-[#6f4668] opacity-0"></div>
            </MotionButton>
            <MotionButton
              onClick={() =>
        ...
        <img
          src="/profile.jpg"
          alt="Chef"
          className={` w-[95%]  xl:w-160 object-contain drop-shadow-2xl border-b-[10px] border-[#6f4668]
            opacity-0
          ${
            i18n.language === "ar"
              ? "left-0 rounded-br-[12rem] rounded-bl-[1rem] md:rounded-tr-[1rem]  border-r-[4px]"
