...
function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-2/3 lg:h-[80vh] flex flex-col gap-5 lg:p-1 text-[#f7f7f7] mb-5">
        ...
        <div className="flex flex-col gap-4 md:gap-5 pt-5 font-[350] text-xl md:text-2xl lg:text-3xl ltr ">
          <button
            onClick={() =>
